...
(function() {
  ...
  recordSimilarity = function(a, b, fields) {
    var i, measure, name, similarity, sum;
  ...
  numberSimilarity = function(a, b) {
    var diff, diff1, diff2, distance, max;
  ...
  exports.findMostSimilar = function(query, items, fields, callback) {
    var i, item, maxSimilarity, result, similarity;
    ...
    return callback(result, maxSimilarity);
  };
